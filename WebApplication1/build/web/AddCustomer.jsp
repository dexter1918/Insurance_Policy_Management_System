...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/newCSS/styleForAddCustomer.css">
        <!--===============================================================================================-->
        <script>
    ...
    <body>
        ...
        <form action="AddCustomer" method="post" class="">
            <div>
                ...
                <div class="input-field">
                    <i class="fas fa-user"></i>
                    <input name="addressOne" type="text" placeholder="AddressLine 1" required/>
                </div>
                <div class="input-field">
                    <i class="fas fa-user"></i>
                    <input name="addresstwo" type="text" placeholder="AddressLine 2" required/>
                </div>
                <div class="input-field">
                    <i class="fas fa-user"></i>
                ...
                <div class="input-field">
                    <i class="fas fa-user"></i>
                    <input name="pincode" type="text" placeholder="Pin Code" required/>
                </div>
                <div class="button">
                    <input type="submit" value="Add" class="btnn solid" required/>
                </div>
            </div>
        </form>
