    ...
    <body>
        ...
        <%      try {
                ...
                PreparedStatement pstmt = connection.prepareStatement(
                        "SELECT * FROM customer,address,contactaddress where  customer.customer_id=address.customer_id and customer.customer_id=contactaddress.customer_id and customer.company_id=address.company_id and customer.company_id=contactaddress.company_id and customer.company_id=" + i + " and  customer.customer_id=" + cid + ";");
            ...
            <div class="right">
                ...
                <div class="projects">
                    <div class="projects_data">
                        <div class="data">
                            <h4>Address</h4>
                            <p><%=rs.getString("addressone")%>, <%=rs.getString("addresstwo")%>, <%=rs.getString("city")%>, <%=rs.getString("state")%>, <%=rs.getString("country")%></p>
                        </div>
                        <div class="data">
                            <h4>Phone Number</h4>
