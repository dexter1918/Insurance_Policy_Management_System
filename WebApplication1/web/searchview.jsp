...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/newCSS/mainForPolicy.css">
        ...
        <div class="limiter">
            <div class="container-table10155">
                <div class="wrap-table100">
                    <h2 style="color: white;">Policy Search Result...</h2>
                            ...
                            <table>
                                <thead>
                                    <tr class="row100 head">
                                        ...
                                        <th class="cell100 column3">Launch Date</th>
                                        <th class="cell100 column4">Premium Amount</th>
                                        <th class="cell100 column5">Coverage Amount</th>
                                        <th class="cell100 column6">MinAgeOffering</th>
                                        <th class="cell100 column7">MaxAgeOffering</th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr class="row100 body">
                                        ...
                                        <td class="cell100 column6"><%=pList.get(5)%></td>
                                        <td class="cell100 column6"><%=pList.get(6)%></td>
                                    </tr>
                                    <% }
                                        }
                                        if (count == 0) { %>
