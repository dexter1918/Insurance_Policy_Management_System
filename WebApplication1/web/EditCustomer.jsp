...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/newCSS/styleForEditCustomerDetails.css">
        <!--===============================================================================================-->
        <script>
...
%>
            <nav class="navbar navbar-expand-lg navbar-light bg-gradient-secondary">
                <h1>
                    <a class="navbar-brand text-white" href="HomePage2.jsp">
                     <%=name  %> Insurance
                    </a>
                </h1>
        ...
        <form action="EditCustomer" method="post" class="sign-in-form">
            <div>
                <h2 class="title">Edit Customer Details</h2>
                <div class="input-field">
                    <i class="fas fa-user"></i>
                    <input type="hidden" name="customerId" value="<%=e.getCustomerId()%>" >
                    <input name="customerName" type="text" placeholder="Name" value="<%= e.getCustomerName()%>" required/>
                </div>
                <div class="input-field">
                    <i class="fas fa-user"></i>
                    <input name="email" type="email" placeholder="Email" value="<%= e.getContactAddress().getEmail()%>" required/>
                </div>
                <div class="input-field">
                    <i class="fas fa-user"></i>
                    <input name="phoneNumber" type="number" placeholder="Phone Number" value="<%= e.getContactAddress().getPhoneNumber()%>" required/>
                </div>
                <div class="input-field">
                    <i class="fas fa-user"></i>
                    <input name="occupation" type="text" placeholder="Occupation" value="<%= e.getOccupation()%>" required/>
                </div>
                <div class="input-field">
                    <i class="fas fa-user"></i>
                    <input name="age" type="number" placeholder="Age" value="<%= e.getAge()%>" required/>
                </div>
                <div class="input-field">
                    <i class="fas fa-user"></i>
                    <input name="gender" type="text" placeholder="Gender" value="<%= e.getGender()%>" required/>
                </div>
                <div class="input-field">
                    <i class="fas fa-user"></i>
                    <input name="annualIncome" type="number" placeholder="Annual Income" value="<%= e.getAnnualIncome()%>" required/>
                </div>
                <div class="input-field">
                    <i class="fas fa-user"></i>
                    <input name="addressOne" type="text" placeholder="AddressLine 1" value="<%= e.getAddress().getAddressOne()%>" required/>
                </div>
                <div class="input-field">
                    <i class="fas fa-user"></i>
                    <input name="addresstwo" type="text" placeholder="AddressLine 2" value="<%= e.getAddress().getAddressTwo()%>" required/>
                </div>
                <div class="input-field">
                    <i class="fas fa-user"></i>
                    <input name="city" type="text" placeholder="City" value="<%= e.getAddress().getCity()%>" required/>
                </div>
                <div class="input-field">
                    <i class="fas fa-user"></i>
                    <input name="state" type="text" placeholder="State" value="<%= e.getAddress().getState()%>" required/>
                </div>
                <div class="input-field">
                    <i class="fas fa-user"></i>
                    <input name="country" type="text" placeholder="Country" value="<%= e.getAddress().getCountry()%>" required/>
                </div>
                <div class="input-field">
                    <i class="fas fa-user"></i>
                    <input name="pincode" type="text" placeholder="Pin Code" value="<%= e.getAddress().getPincode()%>" required/>
                </div>
